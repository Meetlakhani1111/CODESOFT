...
class TodoApp(Tk):
    ...
    def create_input_frame(self):
        ...
        """
        frame = Frame(self, bg = "#38383f", height = 100, padx = 20, pady = 20)
        frame.pack(fill = X)
        return frame
    ...
    def create_new_item_entry_box(self):
        ...
        """
        entry = Entry(self.item_input_frame, width = 30, borderwidth = 0, font = ('Helvetica', 22))
    ...
    def create_add_button(self):
        ...
        """
        button = Button(self.item_input_frame, text = "Add to list", width = 10, borderwidth = 0, font = ('Helvetica', 14, 'bold'), bg = "#2e5d72", fg = "#ffffff", command = self.add_item)
